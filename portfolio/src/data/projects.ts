...
const projects: Project[] = [
  ...
  {
    id: 'fpvQuadDroneRetractableLegs',
    category: '3d',
    categoryLabel: '3D Model',
  ...
  {
    id: '10InchMark4V2AliexpressFpvGpsFrontMount',
    category: '3d',
    categoryLabel: '3D Model',
  ...
  {
    id: 'kuugoM4FrontLicensePlateMount',
    category: '3d',
    categoryLabel: '3D Model',
  ...
  {
    id: 'kuugoM4ElectricScooterInternalSteeringTube',
    category: '3d',
    categoryLabel: '3D Model',
  ...
  {
    id: 'hswHoneycombDt9205pMultimeterHolder',
    category: '3d',
    categoryLabel: '3D Model',
  ...
  {
    id: 'hswHoneycombDrillBatteryHolder',
    category: '3d',
    categoryLabel: '3D Model',
  ...
  {
    id: 'deskLampThatSlidesUnderTheMonitorArm',
    category: '3d',
    categoryLabel: '3D Model',
